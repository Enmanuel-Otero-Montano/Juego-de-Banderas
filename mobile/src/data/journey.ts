...
const translatedStages: Record<LocaleCode, JourneyStageText[]> = {
  ...
  fr: [
    { title: 'Cap au sud', label: 'Amérique du Sud', focus: 'Premiers pas' },
    { title: 'Du nord aux Caraïbes', label: 'Amériques', focus: 'Nord, centre et îles' },
    { title: 'Classiques européens', label: 'Europe', focus: 'Europe occidentale' },
    { title: 'Nord et est', label: 'Europe', focus: 'De la Baltique à la Méditerranée' },
    { title: 'Géants de l’Asie', label: 'Asie', focus: 'Les plus reconnaissables' },
    { title: 'Asie du Sud-Est et Himalaya', label: 'Asie', focus: 'Nouveaux horizons' },
    { title: 'Proche-Orient', label: 'Asie', focus: 'Couleurs et symboles' },
    { title: 'Portes de l’Afrique', label: 'Afrique', focus: 'Nord, ouest et sud' },
    { title: 'Centre et est', label: 'Afrique', focus: 'La difficulté augmente' },
    { title: 'Afrique australe', label: 'Afrique', focus: 'Maîtriser le continent' },
    { title: 'Îles du Pacifique', label: 'Océanie', focus: 'Drapeaux insulaires' },
    { title: 'Traversée des frontières', label: 'Monde', focus: 'Le défi final' },
  ],
  de: [
    { title: 'Kurs nach Süden', label: 'Südamerika', focus: 'Erste Schritte' },
    { title: 'Vom Norden in die Karibik', label: 'Amerika', focus: 'Nord, Mitte und Inseln' },
    { title: 'Europäische Klassiker', label: 'Europa', focus: 'Westeuropa' },
    { title: 'Norden und Osten', label: 'Europa', focus: 'Von der Ostsee bis zum Mittelmeer' },
    { title: 'Giganten Asiens', label: 'Asien', focus: 'Die bekanntesten' },
    { title: 'Südostasien und Himalaya', label: 'Asien', focus: 'Neue Horizonte' },
    { title: 'Naher Osten', label: 'Asien', focus: 'Farben und Symbole' },
    { title: 'Tore nach Afrika', label: 'Afrika', focus: 'Norden, Westen und Süden' },
    { title: 'Zentral- und Ostafrika', label: 'Afrika', focus: 'Es wird schwieriger' },
    { title: 'Südliches Afrika', label: 'Afrika', focus: 'Beherrsche den Kontinent' },
    { title: 'Pazifikinseln', label: 'Ozeanien', focus: 'Inselflaggen' },
    { title: 'Über Grenzen hinweg', label: 'Welt', focus: 'Die letzte Herausforderung' },
  ],
};
